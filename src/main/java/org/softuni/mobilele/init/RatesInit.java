...
public class RatesInit implements CommandLineRunner {
    ...
    public RatesInit(RestTemplate restTemplate,
                     OpenExchangeRateConfig openExchangeRateConfig, CurrencyService currencyService) {
        ...
        if (openExchangeRateConfig.isEnabled()) {
            ...
            String openExchangeRateUrlTemplate =
                    openExchangeRateConfig.getSchema()
                            ...
                            + "?app_id={app_id}&show_alternative=1&symbols={symbols}";
